...
\begin{itemize}
    \item \textbf{GitHub Repository:} \url{https://github.com/your-username/Tech-Challenge-FIAP}
    \item \textbf{Live API URL:} \url{https://your-api-url.onrender.com/docs}
    \item \textbf{Architecture \& Demo Video:} \url{https://youtube.com/your-video-link}
\end{itemize}
...
% NOTE: Place your architecture diagram image in the 'assets' folder and uncomment the lines below.
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=\textwidth]{assets/architecture_diagram.png}
%     \caption{System Architecture: From Ingestion to Analytical Views}
% \end{figure}
